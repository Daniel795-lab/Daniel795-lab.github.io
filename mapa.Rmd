...
date: "Actualizado al 03-06-2020"
...
```{r echo=FALSE, force = T, message= F, warning = F, collapse=TRUE}
...
## Como se aprecia en la tabla anterior, hemos ayudado a **73** familias (en promedio de 3 integrantes) en cuatro comunas.
